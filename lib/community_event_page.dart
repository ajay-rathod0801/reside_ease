          ...
          body: ListView(
            ...
            children: [
              ...
              CardEvents(
                ...
                description: 'Join us for a fun day of scuba diving in the Carribean. We will be meeting at the beach at 8:00 AM. Please bring your own gear. We will be providing lunch. See you there!',
                onBookmarkPressed: () {
                  // Add bookmark logic here
                },
                onLearnMorePressed: () {
              ...
              CardEvents(
                ...
                title: 'Saudi Arabia 🕌',
                description: 'A trip to Saudi Arabia is incomplete without a visit to the holy city of Mecca. Join us for a spiritual journey to the birthplace of Islam. We will be meeting at the airport at 8:00 AM. Please bring your own gear. We will be providing lunch. See you there!',
                onBookmarkPressed: () {
                  // Add bookmark logic here
                },
                onLearnMorePressed: () {
